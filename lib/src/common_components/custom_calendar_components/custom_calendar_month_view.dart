...
import 'package:schoolsgo_web/src/common_components/custom_calendar_components/custom_weekday_widget.dart';
import 'package:schoolsgo_web/src/constants/colors.dart';

class CustomMonthView<T extends Object?> extends StatefulWidget {
  ...
  /// [CustomMonthView.nextPage] or [CustomMonthView.previousPage]
  ...
  @override
  CustomMonthViewState<T> createState() => CustomMonthViewState<T>();
}

/// State of month view.
class CustomMonthViewState<T extends Object?> extends State<CustomMonthView<T>> {
  ...
  @override
  void didUpdateWidget(CustomMonthView<T> oldWidget) {
  ...
  Widget _defaultCellBuilder(date, List<CalendarEventData<T>> events, isToday, isInMonth) {
    return FilledCell<T>(
      ...
      backgroundColor: isInMonth ? Colors.white : Colors.white60,
      events: events,
  ...
  /// as [CustomMonthView.pageTransitionDuration] and [CustomMonthView.pageTransitionCurve]
  /// respectively.
