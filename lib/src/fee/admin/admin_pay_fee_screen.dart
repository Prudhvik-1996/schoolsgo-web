            ...
            child: SizedBox(
              ...
              child: Directionality(
                ...
                child: TextField(
                  ...
                  enabled: eachStudentFeePaidForFeeTypeBean.fee != eachStudentFeePaidForFeeTypeBean.feePaid,
                  inputFormatters: [
                    FilteringTextInputFormatter.allow(RegExp(r"[0-9.]")),
                    TextInputFormatter.withFunction((oldValue, newValue) {
                      try {
                ...
                child: SizedBox(
                  ...
                  child: Directionality(
                    ...
                    child: TextField(
                      ...
                      enabled: eachStudentFeePaidForCustomFeeTypeBean.fee != eachStudentFeePaidForCustomFeeTypeBean.feePaid,
                      inputFormatters: [
                        FilteringTextInputFormatter.allow(RegExp(r"[0-9.]")),
                        TextInputFormatter.withFunction((oldValue, newValue) {
                          try {
