...
class _WebViewXPageState extends State<WebViewXPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ),
      // ),
      body: _isLoading ? CircularProgressIndicator() : _buildWebViewX(),
    );
  }
  ...
  Widget _buildWebViewX() {
    return WebViewX(
      ...
      onWebViewCreated: (controller) => webviewController = controller
        ..loadContent(
          'https://storage.googleapis.com/storage-schools-go/video_2022-06-22_23-27-29-3215861684246323.mp4?alt=media',
          SourceType.url,
        ),
