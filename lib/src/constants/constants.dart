...
const String CREATE_OR_UPDATE_MONTH_WISE_STUDENT_ATTENDANCE_BEANS = "/attendance/createOrUpdateStudentMonthWiseAttendance";
const String GET_DATE_RANGE_STUDENT_ATTENDANCE_BEANS = "/attendance/getStudentDateRangeAttendance";
const String NOTIFY_STUDENTS_FOR_ABSENCE = "/attendance/notifyStudentsForAbsence";
...
const String CREATE_OR_UPDATE_SUBJECT = "/commons/createOrUpdateSubject";
const String CREATE_OR_UPDATE_SUBJECTS = "/commons/createOrUpdateSubjects";
...
const String GET_FEE_DETAILS_REPORT = "/reports/getDetailedFeeReport";
...
const String DOWNLOAD_STUDENT_EXAM_SUMAMRY = "/memo/downloadExamSummaryForStudent";
const String DOWNLOAD_HALL_TICKETS = "/memo/downloadExamHallTickets";
const String GET_EXAMS_FOR_STUDENTS_SUMMARY = "/exams/getExamsForStudentsSummary";
