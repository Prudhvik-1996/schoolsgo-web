...
class EachStudentPdfDownloadForFaExam {
  ...
  //
  //     CustomExam customExamForStudent = CustomExam.fromJson(faExam.toJson());
  ...
  //                   ((faExam.examSectionSubjectMapList ?? [])
  ...
  //                     children: [
  //                       Text(
  //                         "Report of ${faExam.customExamName ?? "-"}",
  //                         style: TextStyle(
  ...
  //       : "${faExam.customExamName} Memos.pdf";
  //   anchorElement.click();
  //   updateMessage(null);
  // }
