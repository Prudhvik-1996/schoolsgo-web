...
class SectionPickerWidget extends StatefulWidget {
  SectionPickerWidget({
    Key? key,
  ...
  @override
  _SectionPickerWidgetState createState() => _SectionPickerWidgetState();
}

class _SectionPickerWidgetState extends State<SectionPickerWidget> {
