  ...
  void createNewChatBean() {
    setState(() {
      newChatBean = ChatBean(
        ...
        parentChatId: null,
        senderId: widget.teacherProfile.teacherId,
        senderName: widget.teacherProfile.teacherName,
        senderRole: "TEACHER",
        status: "active",
      );
    });
    ...
    return Column(
      ...
      children: [
        ...
        for (ChatBean eachChatBean in dateWiseChatBean.chatBeans)
          chatBubbleWidget(eachChatBean, eachChatBean.senderRole == "TEACHER" && eachChatBean.senderId == widget.teacherProfile.teacherId)
      ],
    );
  }
