        ...
        onTap: () {
          ...
          setState(() {
            if (_selectedSection == section) {
              ...
              List<int?> teacherIdsOfTds = _tdsList.where((e) => e.sectionId == section.sectionId).map((e) => e.teacherId).toSet().toList();
              _teachers = _teachers.where((e) => teacherIdsOfTds.contains(e.teacherId)).toList() +
                  _teachers.where((e) => !teacherIdsOfTds.contains(e.teacherId)).toList();
            }
